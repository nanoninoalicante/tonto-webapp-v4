...
const PrimaryPost = (props: any) => {
    ...
    return (
        props.props.user.data.userInfo.id !== "" ?
            <div className="absolute lg:mx-3/4 mx-full mt-28 justify-center bg-white rounded-b-xl">
                <div className="flex flex-col justify-center items-center border-b-2">
                    ...
                    <h3 className="mb-4 mx-4 text-xs font-medium max-h-20 text-coolGray-400 overflow-scroll no-scrollbar">
