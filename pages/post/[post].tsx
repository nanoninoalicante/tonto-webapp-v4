                    ...
                    <main className='flex justify-center'>
                        <React.Fragment>
                            ...
                            <GlobalPlayer
                                ...
                                next={props.next}
                                existsId={props.existsId} />
                            <div className="text-white sm:hidden flex flex-row items-center text-lg fixed bottom-0 z-50 px-4 w-full h-[4rem] bg-black opacity-70 shadow-lg mouse transition ease-in duration-200 focus:outline-none">
